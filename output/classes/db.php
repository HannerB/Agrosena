...
class DB
{
	...
	*/
	...
	protected static function _fillTablesList( $conn )
	{
		...
		{
			$dalTables[$conn->connId][] = array("name" => "criterio", "varname" => "jovenes_gober_at_107_180_57_13__criterio", "altvarname" => "criterio", "connId" => "jovenes_gober_at_107_180_57_13", "schema" => "", "connName" => "agrojam at 107.180.57.13");
			$dalTables[$conn->connId][] = array("name" => "equipos", "varname" => "jovenes_gober_at_107_180_57_13__equipos", "altvarname" => "equipos", "connId" => "jovenes_gober_at_107_180_57_13", "schema" => "", "connName" => "agrojam at 107.180.57.13");
			$dalTables[$conn->connId][] = array("name" => "integrantes", "varname" => "jovenes_gober_at_107_180_57_13__integrantes", "altvarname" => "integrantes", "connId" => "jovenes_gober_at_107_180_57_13", "schema" => "", "connName" => "agrojam at 107.180.57.13");
			$dalTables[$conn->connId][] = array("name" => "registros", "varname" => "jovenes_gober_at_107_180_57_13__registros", "altvarname" => "registros", "connId" => "jovenes_gober_at_107_180_57_13", "schema" => "", "connName" => "agrojam at 107.180.57.13");
			$dalTables[$conn->connId][] = array("name" => "retos", "varname" => "jovenes_gober_at_107_180_57_13__retos", "altvarname" => "retos", "connId" => "jovenes_gober_at_107_180_57_13", "schema" => "", "connName" => "agrojam at 107.180.57.13");
		}
	}
