...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data["connName"] = "agrojam at 107.180.57.13";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;107.180.57.13;bdemprendete;emprendete23*;;agrojam;;1"; //currently unused

		$this->_connectionsIdByName["agrojam at 107.180.57.13"] = "jovenes_gober_at_107_180_57_13";

		$data["connInfo"] = array();
		$data["ODBCUID"] = "bdemprendete";
		$data["ODBCPWD"] = "emprendete23*";
		$data["leftWrap"] = "`";
		$data["rightWrap"] = "`";
		...
		$data["connInfo"][0] = "107.180.57.13";
		$data["connInfo"][1] = "bdemprendete";
		$data["connInfo"][2] = "emprendete23*";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "agrojam";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=107.180.57.13;Uid=bdemprendete;Pwd=emprendete23*;Database=agrojam;OPTION=3";
		// encription set
