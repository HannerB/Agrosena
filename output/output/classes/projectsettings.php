...
class ProjectSettings
{
	...
	*/
	...
	function getConnId()
	{
		...
		if( $connId == "" ) {
			return "jovenes_gober_at_107_180_57_13";
		}
		return $connId;
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "criterio" ] = array( "url" => "criterio", "type" => 0 );
	$projectEntitiesReverse[ "criterio" ] = "criterio";
	$projectEntities[ "equipos" ] = array( "url" => "equipos", "type" => 0 );
	$projectEntitiesReverse[ "equipos" ] = "equipos";
	$projectEntities[ "integrantes" ] = array( "url" => "integrantes", "type" => 0 );
	$projectEntitiesReverse[ "integrantes" ] = "integrantes";
	$projectEntities[ "retos" ] = array( "url" => "retos", "type" => 0 );
	...
	$projectEntities[ "add_ponencias" ] = array( "url" => "add_ponencias", "type" => 1 );
	$projectEntitiesReverse[ "add_ponencias" ] = "add_ponencias";
	$projectEntities[ "add_asistentes" ] = array( "url" => "add_asistentes", "type" => 1 );
	$projectEntitiesReverse[ "add_asistentes" ] = "add_asistentes";
	$projectEntities[ "add_poster" ] = array( "url" => "add_poster", "type" => 1 );
	$projectEntitiesReverse[ "add_poster" ] = "add_poster";
}
