...
class XTempl_Base
{
	 ...
	 function __construct( $hideAddedCharts = false )
	{
		...
		{
			$this->assign_function("resultado_reto1_chart","xt_showchart",
			array(
				"chartName"=>"resultado_reto1",
				"table"=>"resultado reto1",
				"ctype"=>"2DBar"));
			$this->assign_function("resultado_reto2_chart","xt_showchart",
			array(
				"chartName"=>"resultado_reto2",
				"table"=>"resultado reto2",
				"ctype"=>"2DBar"));
			$this->assign_function("resultado_reto3_chart","xt_showchart",
			array(
				"chartName"=>"resultado_reto3",
