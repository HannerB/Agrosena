...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "jovenes_gober_at_107_180_57_13";
		$data["connName"] = "u804842339_agrosena at 193.203.175.34";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;193.203.175.34;u804842339_agrosena;Agrosena2024;;u804842339_agrosena;;1"; //currently unused

		$this->_connectionsIdByName["u804842339_agrosena at 193.203.175.34"] = "jovenes_gober_at_107_180_57_13";

		$data["connInfo"] = array();
		$data["ODBCUID"] = "u804842339_agrosena";
		$data["ODBCPWD"] = "Agrosena2024";
		$data["leftWrap"] = "`";
		$data["rightWrap"] = "`";
		...
		$data["connInfo"][0] = "193.203.175.34";
		$data["connInfo"][1] = "u804842339_agrosena";
		$data["connInfo"][2] = "Agrosena2024";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "u804842339_agrosena";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=193.203.175.34;Uid=u804842339_agrosena;Pwd=Agrosena2024;Database=u804842339_agrosena;OPTION=3";
		// encription set
		...
		$connectionsData["jovenes_gober_at_107_180_57_13"] = $data;
