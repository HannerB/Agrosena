...
$tdataintegrantes[".pagesByType"] = my_json_decode( "{\"list\":[\"list\"],\"search\":[\"search\"]}" );
$tdataintegrantes[".originalPagesByType"] = $tdataintegrantes[".pagesByType"];
$tdataintegrantes[".pages"] = types2pages( my_json_decode( "{\"list\":[\"list\"],\"search\":[\"search\"]}" ) );
$tdataintegrantes[".originalPages"] = $tdataintegrantes[".pages"];
$tdataintegrantes[".defaultPages"] = my_json_decode( "{\"list\":\"list\",\"search\":\"search\"}" );
...
// Begin Lookup settings
				$edata["LookupType"] = 2;
	$edata["LookupTable"] = "registros_vista";
			$edata["autoCompleteFieldsOnEdit"] = 0;
	$edata["autoCompleteFields"] = array();
		$edata["autoCompleteFields"][] = array('masterF'=>"cedula", 'lookupF'=>"num_doc");
	$edata["LCType"] = 0;

	
		
	$edata["LinkField"] = "nombre_completo";
...
$masterTablesData["integrantes"] = array();
	...
	//if !@t.bReportCrossTab
			$strOriginalDetailsTable="equipos";
	$masterParams = array();
	$masterParams["mDataSourceTable"]="equipos";
	$masterParams["mOriginalTable"]= $strOriginalDetailsTable;
	$masterParams["mShortTable"]= "equipos";
	$masterParams["masterKeys"]= array();
	$masterParams["detailKeys"]= array();

	$masterParams["type"] = PAGE_LIST;
					$masterTablesData["integrantes"][0] = $masterParams;
				$masterTablesData["integrantes"][0]["masterKeys"] = array();
	$masterTablesData["integrantes"][0]["masterKeys"][]="id";
				$masterTablesData["integrantes"][0]["detailKeys"] = array();
	$masterTablesData["integrantes"][0]["detailKeys"][]="idequipo";
