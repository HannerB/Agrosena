...
'label' => array( 'text' => '<p class="ql-align-center"><span class="ql-size-large">CERTIFICADO </span></p><p class="ql-align-center">DE PARTICIPACIÓN</p><p><span class="ql-size-large">﻿</span></p>',
'type' => 0 ),
'editedByRte' => false,
'color' => '#005008',
'font-size' => '30px',
...
'label' => array( 'text' => '<p class="ql-align-center">Reconocimiento para:</p>',
'type' => 0 ),
'editedByRte' => true,
'font-size' => '25px' ),
...
'label' => array( 'text' => 'Reconocemos y agradecemos al presente por su participación en nuestro evento de Agrojam Esperamos su presencia en próximos encuentros que le serán notificados.',
'type' => 0 ),
'editedByRte' => false,
'font-size' => '20px' ),
...
'image' => array( 'image' => 'LOGOS-NODOS-2-02.png',
'source' => 2 ),
'width' => '330px',
'height' => '',
...
[data-page="registros_view"][data-itemid="image1"] {
    opacity: 0.65;
}' ),
'image2' => array( 'type' => 'image',
'image' => array( 'image' => 'sena-colombia-logo-green39a900.png',
'source' => 2 ),
'width' => '100px',
'customCSS' => '/* Put  your custom CSS code here */
...
[data-page="registros_view"][data-itemid="image2"] {
    opacity: 0.65;
}' ),
'image3' => array( 'type' => 'image',
'image' => array( 'image' => 'Logo_cuc.png',
'source' => 2 ),
'width' => '290px',
'customCSS' => '/* Put  your custom CSS code here */
...
[data-page="registros_view"][data-itemid="image3"] {
