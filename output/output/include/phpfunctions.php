...
function CustomExpression($value, $data, $field, $ptype, $table="")
{
	...
	if(!$table)
		$table = $strTableName;
				if($table=="registros_descargar" && $field=="tipo_doc")
	{
		if($value == "Cedula de Ciudadania"){
		$value = "<strong>C.C</strong>";
}else if($value == "Tarjeta de Identidad"){
		$value = "<strong>T.I</strong>";
}else if($value == "Cedula de Extranjeria"){
		$value = "<strong>C.E</strong>";
}else if($value == "Pasaporte"){
		$value = "<strong>P.P</strong>";
};
		return $value;
	}
				if($table=="registros_ponentes" && $field=="tipo_doc")
	{
		if($value == "Cedula de Ciudadania"){
		$value = "<strong>C.C</strong>";
}else if($value == "Tarjeta de Identidad"){
		...
		return $value;
				...
				if($table=="registros_participantes" && $field=="tipo_doc")
	{
		if($value == "Cedula de Ciudadania"){
		$value = "<strong>C.C</strong>";
}else if($value == "Tarjeta de Identidad"){
		...
		return $value;
				...
				if($table=="registros_poster" && $field=="tipo_doc")
	{
		if($value == "Cedula de Ciudadania"){
		$value = "<strong>C.C</strong>";
}else if($value == "Tarjeta de Identidad"){
		...
		return $value;
				...
				if($table=="registros_asistente" && $field=="tipo_doc")
	{
		if($value == "Cedula de Ciudadania"){
		$value = "<strong>C.C</strong>";
}else if($value == "Tarjeta de Identidad"){
		...
		return $value;
				...
				if($table=="registrosParticipantes" && $field=="tipo_doc")
	{
		if($value == "Cedula de Ciudadania"){
		$value = "<strong>C.C</strong>";
}else if($value == "Tarjeta de Identidad"){
		...
		return $value;
				...
				if($table=="registrosPoster" && $field=="tipo_doc")
	{
		if($value == "Cedula de Ciudadania"){
		$value = "<strong>C.C</strong>";
}else if($value == "Tarjeta de Identidad"){
		...
		return $value;
				...
				if($table=="registrosPonencias" && $field=="tipo_doc")
	{
		if($value == "Cedula de Ciudadania"){
		$value = "<strong>C.C</strong>";
}else if($value == "Tarjeta de Identidad"){
