...
$tdataregistros[".pagesByType"] = my_json_decode( "{\"add\":[\"add\"],\"list\":[\"list\",\"list1\"],\"search\":[\"search\"],\"view\":[\"view\"]}" );
$tdataregistros[".originalPagesByType"] = $tdataregistros[".pagesByType"];
$tdataregistros[".pages"] = types2pages( my_json_decode( "{\"add\":[\"add\"],\"list\":[\"list\",\"list1\"],\"search\":[\"search\"],\"view\":[\"view\"]}" ) );
...
if(mlang_getcurrentlang()=="Spanish")
{
	...
	$fieldLabelsregistros["Spanish"]["num_doc"] = "No. Documento";
	...
	$pageTitlesregistros["Spanish"]["add"] = "Registro para retos";
